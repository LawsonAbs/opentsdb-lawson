...
public class Config {
  ...
  */  
  ...
  /**
   * Searches a list of locations for a valid opentsdb.properties file
   * 
   ...
   * 
   * Defaults for Linux based systems are:
   * ./opentsdb.properties
   * /etc/opentsdb.properties
   * /etc/opentsdb/opentdsb.conf
   * /opt/opentsdb/opentsdb.properties
   * 
  ...
  protected void loadConfig() throws IOException {
    ...
    file_locations.add("E:\\intellij_Project\\opentsdb_dev\\src\\main\\java\\net\\opentsdb\\opentsdb.properties");

    // add default locations based on OS
//    if (System.getProperty("os.name").toUpperCase().contains("WINDOWS")) {
//      file_locations.add("net/opentsdb/opentsdb.properties");
//      file_locations.add("net/opentsdb/opentsdb.properties");
//    } else {
//      file_locations.add("net/opentsdb/opentsdb.properties");
//      file_locations.add("net/opentsdb/opentsdb.properties");
